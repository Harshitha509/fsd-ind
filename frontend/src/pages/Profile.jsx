...
import { extractSkillsFromPDF } from '../utils/pdfParser';
...
const Profile = () => {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      // Use the separated utility function to keep this component clean!
      const foundSkills = await extractSkillsFromPDF(file);
